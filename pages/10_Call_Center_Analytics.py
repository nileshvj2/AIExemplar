...
def main():
    ...
    Use Case: This app is intended to replicate some of the functionality of a call center monitoring solution. 
    This solution uses variety of AI services like Speech2Text, Azure OpenAI, Text Analytics, Summarization and Named Entity Recognition to analyze calls for compliance, sentiment, and named entities.
